...
import { useProofInfo, ProofStatusEnum, updateGlobalProofStatus } from '../stores/proofProvider';
...
const LoadingScreen: React.FC = () => {
    ...
    useEffect(() => {
        ...
        } else if (status === ProofStatusEnum.FAILURE || status === ProofStatusEnum.ERROR) {
    ...
    useEffect(() => {
        const processPayload = async () => {
            ...
            await sendDscPayload(useUserStore.getState().passportData as PassportData);
        };
