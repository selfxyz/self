...
interface IAppContext {
   ...
   */
  handleProofResult: (sessionId: string, success: boolean, error_code?: string, reason?: string) => void;
}
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const handleProofResult = (sessionId: string, proof_verified: boolean, error_code?: string, reason?: string) => {
    console.log(
