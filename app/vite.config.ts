    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          'screens-prove': ['./src/navigation/prove', './src/utils/proving'],
          'screens-settings': ['./src/navigation/settings'],
          'screens-recovery': ['./src/navigation/recovery'],
          'screens-dev': ['./src/navigation/dev'],
          'screens-aesop': ['./src/navigation/aesop'],
        },
      },
    },
  },
