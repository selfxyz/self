import { attributeToPosition, attributeToPosition_ID } from '../../constants/constants';
...
export function getAttributeFromUnpackedReveal(unpackedReveal: string[], attribute: string, id_type: 'passport' | 'id') {
...
export function unpackReveal(revealedData_packed: string | string[], id_type: 'passport' | 'id'): string[] {
...
export function formatAndUnpackReveal(revealedData_packed: string[], id_type: 'passport' | 'id'): string[] {
...
export function revealBitmapFromAttributes(disclosureOptions: SelfAppDisclosureConfig, id_type: 'passport' | 'id'): string[] {
