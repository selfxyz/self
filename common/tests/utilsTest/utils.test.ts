...
describe('utils', function () {
  ...
  it('encodes "name" and calculate namehash', async function () {
    ...
    const value = BigInt("948855446484890256796791120157965939898937470990304708559398895582336127482");
  ...
  it('should compute Poseidon hash of DOB', async function () {
    ...
    const value = BigInt("124042181534158974680486158040584178760834524593809439015791333757793339013");
  });
...
describe('Produce desired commitment', function () {
  it('should generate the data commitment and final commitment for aadhaar registration ', async function () {
    ...
    const value = BigInt("323373849911026295981485308378167295217106366770003265244905549589414909141");
...
describe('produce desired nullifier',function (){
  it('should generate the correct nullifier for aadhaar',async function (){
    ...
    const value = BigInt("14300676060298489109925451265331000889291307788153914741032606453496314896133");
