...
import { bigIntToString, formatEndpoint, hashEndpointWithScope, stringToBigInt } from '../src/utils/scope';
...
describe('Scope Utilities', function () {
    ...
    describe('hashEndpointWithScope', function () {
        ...
        it('should produce different hashes for different scopes with same endpoint', () => {
            const endpoint = 'https://example-endpoint-that-exceeds-31-but-is-not-too-long-to-be-a-valid-domain-as-the-max-is-496-chars.com';
    ...
    describe('stringToBigInt', function () {
        ...
        it('should throw an error for strings longer than 25 characters', () => {
            ...
            expect(() => stringToBigInt(longScope)).to.throw('Resulting BigInt exceeds maximum size of 31 bytes');
        });
    });
});
