...
/// @title VerifyRsa122125Pkcs1v1_5
/// @notice Verifies RSA signatures with exponent 122125 using PKCS#1 v1.5 padding
...
template VerifyRsa122125Pkcs1v1_5(CHUNK_SIZE, CHUNK_NUMBER, HASH_SIZE) {
    ...
    component bigPow = FpPow122125Mod(CHUNK_SIZE, CHUNK_NUMBER);
    for (var i = 0; i < CHUNK_NUMBER; i++) {
