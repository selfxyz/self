...
/// @title VerifyRsa107903Pkcs1v1_5
/// @notice Verifies RSA signatures with exponent 107903 using PKCS#1 v1.5 padding
...
template VerifyRsa107903Pkcs1v1_5(CHUNK_SIZE, CHUNK_NUMBER, HASH_SIZE) {
    ...
    component bigPow = FpPow107903Mod(CHUNK_SIZE, CHUNK_NUMBER);
    for (var i = 0; i < CHUNK_NUMBER; i++) {
