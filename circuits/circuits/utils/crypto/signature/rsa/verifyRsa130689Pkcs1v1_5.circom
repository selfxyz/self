...
/// @title VerifyRsa130689Pkcs1v1_5
/// @notice Verifies RSA signatures with exponent 130689 using PKCS#1 v1.5 padding
...
template VerifyRsa130689Pkcs1v1_5(CHUNK_SIZE, CHUNK_NUMBER, HASH_SIZE) {
    ...
    component bigPow = FpPow130689Mod(CHUNK_SIZE, CHUNK_NUMBER);
    for (var i = 0; i < CHUNK_NUMBER; i++) {
