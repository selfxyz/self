...
import { generateCircuitInputsDSC } from 'openpassport-common/utils/circuits/generateInputs';
...
import { getLeafDscTreeFromParsedDsc } from 'openpassport-common/utils/trees';
