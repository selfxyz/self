...
const Switch = ({ value, onValueChange, testID }: { value: boolean; onValueChange?: (next: boolean) => void; testID?: string }) =>
  createElement('input', {
    type: 'checkbox',
    checked: value,
    'data-testid': testID,
...
const Button = ({ title, onPress, disabled, testID }: { title: string; onPress?: () => void; disabled?: boolean; testID?: string }) =>
  createElement(
    'button',
    {
      type: 'button',
