...
1. **Modular feature directories** – group new capabilities (e.g., `mrz/`, `nfc/`, `qr/`) in their own folders and re-export from `src/index.ts` using explicit named exports (avoid `export *`).
