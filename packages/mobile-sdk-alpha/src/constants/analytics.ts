...
export const AadhaarEvents = {
  AADHAAR_DATA_NOT_FOUND: 'Aadhaar: Data Not Found',
  ...
  FIRST_NAME_CHOOSER_ERROR: 'Aadhaar: First Name Chooser Error',
  FIRST_NAME_CHOOSER_SCREEN_OPENED: 'Aadhaar: First Name Chooser Screen Opened',
  FIRST_NAME_CONTINUE_PRESSED: 'Aadhaar: First Name Continue Pressed',
  FIRST_NAME_INDEX_SAVED: 'Aadhaar: First Name Index Saved',
  FIRST_NAME_SAVE_ERROR: 'Aadhaar: First Name Save Error',
  FIRST_NAME_SELECTED: 'Aadhaar: First Name Selected',
  HELP_BUTTON_PRESSED: 'Aadhaar: Help Button Pressed',
  INVALID_NAME_FORMAT: 'Aadhaar: Invalid Name Format',
  LAST_NAME_CHOOSER_ERROR: 'Aadhaar: Last Name Chooser Error',
  LAST_NAME_CHOOSER_SCREEN_OPENED: 'Aadhaar: Last Name Chooser Screen Opened',
  LAST_NAME_CONTINUE_PRESSED: 'Aadhaar: Last Name Continue Pressed',
  LAST_NAME_INDEX_SAVED: 'Aadhaar: Last Name Index Saved',
  LAST_NAME_SAVE_ERROR: 'Aadhaar: Last Name Save Error',
  LAST_NAME_SELECTED: 'Aadhaar: Last Name Selected',
  NAME_OPTIONS_LOADED: 'Aadhaar: Name Options Loaded',
