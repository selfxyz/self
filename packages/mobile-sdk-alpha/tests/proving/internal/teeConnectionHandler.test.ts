...
const makeSnapshot = (overrides: Partial<ProvingStoreSnapshot> = {}): ProvingStoreSnapshot => ({
...
describe('internal teeConnectionHandler', () => {
  let snapshot: ProvingStoreSnapshot;
  ...
  beforeEach(() => {
    ...
    deps = {
      get: vi.fn(() => snapshot),
      set: vi.fn((partial: Partial<ProvingStoreSnapshot>) => {
