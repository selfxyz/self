...
- `packages/mobile-sdk-alpha` (992 source files, 49 deps)
- `app` (417 source files, 152 deps)
- `circuits` (294 source files, 51 deps)
- `contracts` (242 source files, 54 deps)
- `common` (119 source files, 47 deps)
- `packages/mobile-sdk-demo` (67 source files, 56 deps)
- `sdk/core` (32 source files, 26 deps)
