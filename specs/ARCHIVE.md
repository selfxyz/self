...
| `specs/projects/sdk/workstreams/rn-sdk/SPEC-MRZ-CONSOLIDATION.md` | 2026-03-06 | MRZ scanner consolidated onto SDK helpers  | Android delegates to `CameraMrzBridgeHandler`, iOS to `MrzCameraHelper`; composite build enabled via AGP 8.11.2 alignment; `mavenLocal()` removed | PR #1817, PR #2 (pending) |
