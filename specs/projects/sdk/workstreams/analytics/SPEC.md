...
| ANA-05 | Fallback decision events and fallback-offer mini-funnel                  | Done     | High     | ANA-01                 | [plans/ANA-05-fallback-decision-events.md](./plans/ANA-05-fallback-decision-events.md)       | Layer 2 canonical events: `Onboarding: Fallback Offered / Accepted / Declined` at the fallback screens (MRZ, NFC, LogoConfirmation "No"). Carries `from_stage` and `reason`. Enables fallback-offer → fallback-completion sub-funnel and answers "does offering fallback save or lose conversions." |
...
| [plans/ANA-05-fallback-decision-events.md](./plans/ANA-05-fallback-decision-events.md)       | ANA-05 | Done   |
