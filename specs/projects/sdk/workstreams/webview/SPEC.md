...
| WV-05 | Integrate KYC provider Web SDK into ProviderLaunchScreen                                        | Done        | High     | WV-02               | [plans/WV-05-kyc-provider-sdk.md](./plans/WV-05-kyc-provider-sdk.md)                             | Didit Web SDK integrated (PR #1882)                                                                                                                                                                                                                                                                               |
| WV-06 | Wire KYC result through verification pipeline to host lifecycle callback                        | In Progress | High     | WV-05               | [plans/WV-06-kyc-result-flow.md](./plans/WV-06-kyc-result-flow.md)                               | KYC result → kycResultStore → ConfirmIdentificationScreen → lifecycle.setResult()                                                                                                                                                                                                                                 |
...
| [plans/WV-05-kyc-provider-sdk.md](./plans/WV-05-kyc-provider-sdk.md)                             | WV-05 | Done                                      |
| [plans/WV-06-kyc-result-flow.md](./plans/WV-06-kyc-result-flow.md)                               | WV-06 | In Progress                               |
