...
| WV-17 | Recovery phrase restore flow for WebView and tunnel account recovery                            | Ready       | High     | WV-07, WV-08        | [plans/WV-17-recovery-phrase-restore-flow.md](./plans/WV-17-recovery-phrase-restore-flow.md)     | Existing recovery screens are UI-only in webview today. This spec wires phrase-based restore, selected-document validation, and tunnel resume without importing app-only providers.                                                                                                                               |
...
| [plans/WV-17-recovery-phrase-restore-flow.md](./plans/WV-17-recovery-phrase-restore-flow.md)     | WV-17 | Ready                                     |
