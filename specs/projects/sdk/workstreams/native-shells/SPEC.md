...
| NS-08 | Ship AAR + XCFramework to MiniPay                             | Ready    | High     | NS-03      | [plans/NS-08-ship-artifacts-to-minipay.md](./plans/NS-08-ship-artifacts-to-minipay.md)             | ~10 LOC Gradle config for Maven repo target, switch XCFramework to release variants, host XCFramework for SPM.                                                                                                                                                                                                             |
