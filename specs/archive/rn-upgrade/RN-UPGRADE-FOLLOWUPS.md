...
> | ---------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
> | 1 — iOS `PassportOCRView` Fabric vs. Paper           | [DECISIONS.md](../../projects/sdk/DECISIONS.md)                                               | **Decided.** Formal Paper exception with a sunset trigger. Scope corrected: the second Paper site is `MRZScannerView.tsx`, not `QRCodeScanner.tsx`.             |
...
> | 4 — `PassportCamera.android.test.tsx` memory pattern | `app/AGENTS.md`, Test Memory Optimization                                                     | **Decided.** Refactor to hoisted mocks; allowlisting rejected.                                                                                                  |
