...
import { IdentityVerificationHubImpl, IdentityVerificationHubImpl__factory } from './typechain-types/index.js';
...
const IDENTITY_VERIFICATION_HUB_ADDRESS_STAGING = '0x0000000000000000000000000000000000000000';
...
export class SelfBackendVerifier {
  ...
  constructor(scope: string, endpoint: string, mockPassport: boolean = false) {
