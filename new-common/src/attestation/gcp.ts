...
import { PCR0_MANAGER_ADDRESS } from '../foundation/constants/identity.js';
import { RPC_URL } from '../foundation/constants/network.js';
...
export function validatePKIToken(
  ...
  try {
    ...
    const rsaPublicKey = certificates.leaf.publicKey as forge.pki.rsa.PublicKey;
